...
upgrade_dict = {1: [4, 5], 2: [6, 7], 3: [18, 9], # 1 star 兔子，蚂蚁，小丑鱼

                  4: [10, 11], 5: [12, 13], # 2 star mammal 4：羊驼， 5:狼 
                  6: [16, 17], 7: [14, 15],  # 2 star insect 6: 瓢虫 ，7: 蜜蜂
                  18: [30, 19], 9: [21, 22], 8:[30, 19], # 2 star marine  8: 食人鱼 9: 海胆 18:灯笼鱼
